...
public class ItemBuilder {
	...
	public ItemBuilder displayname(String displayname) {
		if (displayname != null) this.displayname = andSymbol ? ChatColor.translateAlternateColorCodes('&', displayname) : displayname;
		return this;
	}
	...
	public ItemBuilder lore(String line) {
		if (line != null) lore.add(andSymbol ? ChatColor.translateAlternateColorCodes('&', line) : line);
		return this;
	}
	...
	public ItemBuilder lore(String line, int index) {
		if (line != null && index != -1) lore.set(index, andSymbol ? ChatColor.translateAlternateColorCodes('&', line) : line);
		return this;
	}
