...
public class ChampionsScoreboard {
	...
	public ChampionsScoreboard(ChampionsPlayer player) {
		...
		this.scoreboard.registerNewObjective("KitpvpBoard", "dummy");
		this.scoreboard.getObjective("KitpvpBoard").setDisplaySlot(DisplaySlot.SIDEBAR);
	...
	public void setSlot(int slot, String value) {
		...
		Score score = scoreboard.getObjective("KitpvpBoard").getScore(name);
		score.setScore(slot);
	...
	public void delete() {
		...
		scoreboard.getObjective("KitpvpBoard").unregister();
	}
	...
	public void setTitle(String title) {
		this.title = title;
		scoreboard.getObjective("StylishBoards").setDisplayName(title);
	}
